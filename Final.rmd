...
This means we reject the null hypothesis that covid921 vaccine is not effective in females.
The Fisher exact test had a p-value of 0.00000001246.          
...
This means we reject the null hypothesis that covid921 vaccine is not effective in the LGBTQ.   
The Fisher exact test had a p-value of 0.000000269.              
...
Although the graphical and numerical summaries show that Drug users who took the placebo were less likely to get covid19 than those who took the vaccine, we conclude that we reject the null hypotheis that covid921 vaccine is not effective in Drug users because the p-value of the chi-squared test and Fisher exact test were less than 0.5.   